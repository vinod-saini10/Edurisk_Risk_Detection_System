  ...
  const handleEmailAlert = async () => {
    ...
    try {
      await sendEmailAlert({
        ...
        name,
        risk_level,
        score: Math.round(predicted_score),
      });
      setEmailSent(true);
      setEmailMsg("✅ Alert email sent successfully!");
    } catch (err) {
      if (!err.response) {
        setEmailMsg("Unable to connect to server.");
      } else {
    ...
    <div style={{ maxWidth: 820, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontSize: "1.2rem", fontWeight: 400, color: "#475569" }}
          >
            /100
          </span>
        </div>
        ...
        {confPct != null && (
          <div>
            ...
            >
              ...
              <span
                style={{ color: riskColor, fontWeight: 700, fontSize: "1rem" }}
              >
                {confPct}%
              </span>
            </div>
      ...
      {whatIf && whatIf.improved_score > predicted_score && (
        ...
        >
          ...
          >
            If you follow the recommendations above, here's your projected
            outcome:
          </p>
          <div
            style={{
          ...
          >
            ...
            >
              ...
              >
                {Math.round(whatIf.improved_score)}
              </div>
              <div
                style={{
                  fontSize: "0.78rem",
              ...
              >
                {whatIf.improved_risk}
              </div>
              <div
                style={{ fontSize: "0.68rem", color: "#34d399", marginTop: 2 }}
              >
                {whatIf.improved_severity}
              </div>
            </div>
          </div>
      ...
      {risk_level === "High Risk" && (
        ...
        >
          ...
          <button
            ...
            disabled={!email || emailSent || emailLoading}
            style={{
