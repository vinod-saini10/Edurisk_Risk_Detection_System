...
export default function StudentDashboard() {
  ...
  const filtered = useMemo(() => {
    ...
    let out = (predictions || []).filter((p) => {
      ...
      return (
        matchRisk && (dateStr.toLowerCase().includes(q) || scoreStr.includes(q))
      );
    });
  ...
  const barData = (() => {
    ...
    return Object.entries(groups).map(([risk, arr]) => ({
      risk,
      avg: arr.length
    ...
    return (
      <div style={{ textAlign: "center", padding: "4rem" }}>
        <p style={{ color: "#64748b", marginBottom: "1rem", fontSize: "1rem" }}>
          No predictions yet. Start by running your first prediction.
        </p>
        <Link
          to="/predict"
          style={{
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      ...
      <div className="page-header-row" style={{ margin: "1rem 0" }}>
        <p style={{ color: "#64748b", margin: 0 }}>
          {total} past prediction{total !== 1 ? "s" : ""}
        </p>
                    ...
                    >
                      ...
                      <td
                        style={{
                          ...
                          fontWeight: 700,
                          color:
                            p.predicted_score >= 75
                              ? "#10b981"
                              : p.predicted_score >= 50
                                ? "#f59e0b"
                                : "#ef4444",
                        }}
                      >
                          ...
                          {explainLoading ? (
                            ...
                            >
                              <div style={{ minWidth: 240 }}>
                                ...
                                <ol>
                                  {(
                                    explainMap[p.id].explanation?.top_reasons ||
                                    []
                                  ).map((r, idx) => (
                                    <li key={idx}>{r}</li>
                                  ))}
                              ...
                              <div style={{ minWidth: 240 }}>
                                ...
                                <ul>
                                  {(
                                    explainMap[p.id].recommendations
                                      ?.study_plan || []
                                  ).map((s, i) => (
                                    <li key={i}>{s}</li>
                                  ))}
      ...
      <p style={{ marginTop: "1rem", color: "#475569", fontSize: "0.85rem" }}>
